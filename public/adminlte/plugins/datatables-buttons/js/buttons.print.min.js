    ...
    u.ext.buttons.print = {
        ...
        action: function(a, e, p, k) {
            ...
            if (c) {
                ...
                c.document.body.innerHTML = "<h1 class='text-center'>" + "Laporan Tahun "+ new Date().getFullYear()  + "</h1><div>" + (p.messageTop || "") + "</div>" + m + "<div class='align-right'>" + (p.messageBottom || "Di print pada ") + new Date() + "</div>";
