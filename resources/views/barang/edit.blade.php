                      ...
                      <div class="card-body">
                          <form action="{{ route('barang_update_proses', $post->id) }}" method="post">
                              ...
                              <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis" name="jenis" value="{{ old('jenis', $post->jenis) }}">
                                    @if ($errors->has('jenis'))
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                    <input type="number" class="form-control" id="jumlah" name="jumlah" value="{{ old('jumlah', $post->jumlah) }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-6">
                                <input type="text" class="form-control" id="pic" name="pic" value="{{ old('pic', $post->pic) }}">
                                </div>
                            </div>
                              <div class="mb-3 row">
